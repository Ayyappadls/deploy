...
// Shared with DiscoveryLocalProvider.js via discoveryTopics.js, so both
// providers reason from one real implementation instead of two.
const { TOPICS, CONTRADICTION_PAIRS, detectTopicKeys, isUncertain, findContradiction } = require('./discoveryTopics');
