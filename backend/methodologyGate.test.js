...
function payload(extra={}) { return { evidence:baseEvidence, signals:[{id:'s1',signal:'Revenue decline',severity:'high'},{id:'s2',signal:'Cash and credit pressure',severity:'high'}], relationships:[{id:'r1',signalAId:'s1',signalBId:'s2',type:'CONTRIBUTES_TO',relationship:'Cash and credit pressure is contributing to the revenue decline',supportingEvidenceIds:['e4','e5']}], openGaps:[], contradictions:[], ...extra }; }
